...
public class AuthUserController {
    ...
    @Autowired
    public AuthUserController(BookstoreUserRegister userRegister, SmsService service, JavaMailSender javaMailSender) {
    ...
    public ContactConfirmationResponse handleRequestEmailConfirmation(@RequestBody ContactConfirmationPayload payload) {
        ...
        message.setFrom("bookstore73@mail.ru");
        message.setTo(payload.getContact());
        SmsCode code = new SmsCode(smsService.generateCode(),300);
        smsService.savaNewCode(code);
        message.setSubject("Bookstore email verification");
        message.setText("verification code is: " + code.getCode());
