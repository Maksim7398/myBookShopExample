            ...
            return {
                init: function () {
                                ...
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        ...
                                        $cart.find('.Cart-product').each(function () {
                                            ...
                                            booksId.push($this.find('[data-sendstatus="KEPT"]').data('bookid'));
                                        });
                                        ...
                                        if ($cart.hasClass('Cart_postponed')) {
                                            $cart.find('.Cart-buyAll').data('bookid', $this.data('bookid'));
                                        }
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('books/rateBook/' + $this.data('bookid'), {
