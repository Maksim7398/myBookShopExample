...
class MainPageControllerTests {
    ...
    public void correctLoginTest() throws Exception{
        mockMvc.perform(formLogin("/signin").user("test@mail.ru").password("123456"))
                .andDo(print())
                .andExpect(status().is3xxRedirection())
    ...
    public void testAuthenticatedAccessToProfilePage() throws Exception {
        mockMvc.perform(get("/profile"))
                ...
                .andExpect(xpath("/html/body/header/div[1]/div/div/div[3]/div/a[4]/span")
                        .string("Дмитрий Петров"));
    }

    @Test
    public void testSearchQuery() throws Exception {
        mockMvc.perform(get("/search/Woyzeck"))
                .andDo(print())
